...
from api.mixins import UltraReadOnlyModelViewSet, QuerySetByUserMixin, UltraModelViewSet
...
from .serializers import ReadChatRoomSerializer, ReadUserChatSerializer, ReadMessageChatSerializer, \
    CreateChatRoomSerializer, UploadFileByMessageSerializer, ReadRequestForSupportSerializer, \
    CreateRequestForSupportSerializer, RequestForSupportSerializer
...
class ChatRoomViewSet(UltraReadOnlyModelViewSet):
    ...
    filterset_fields = ['users', 'users__user']
