...
from api.users.api import ResetPasswordAPIView,ChekingCodeAPI,GetResetPasswordCodeAPI,RegisterAPIView,GoogleAuthAPIView,AccountSettingsAPIView

# from apps.socialauth.views import GoogleSocialAuthView,FacebookSocialAuthView
urlpatterns = [
    ...
    path('setting/',AccountSettingsAPIView.as_view({
    'get': 'get',
    'post': 'post',
    'put': 'put',
    'patch': 'patch',
    }, name='my-accounts-settings'),)
]